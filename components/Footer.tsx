...
const Footer = () => {
  return (
    <footer className="bg-background border-t border-white/10 text-gray-400 py-12">
      ...
      <p className="text-center text-xs text-gray-500 pt-8 border-t border-white/5 mt-8">
